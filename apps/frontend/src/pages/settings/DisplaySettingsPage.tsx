...
const DisplaySettingsPage: React.FC = () => {
  ...
  return (
    <div>
      ...
      {/* テーマ設定セクション */}
      <SectionShell title='テーマ設定' description='アプリの外観テーマを選択できます' icon={Sun} variant='settings'>
      ...
      {/* 言語設定セクション */}
      <SectionShell title='言語設定' description='アプリの表示言語を変更できます' icon={Languages} variant='settings'>
